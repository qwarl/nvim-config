...
keymap.set("n", "<leader>fs", "<cmd>Telescope live_grep<cr>") -- find string in current working directory as you type (need ripgrep to use this. link: https://github.com/BurntSushi/ripgrep#installation)
